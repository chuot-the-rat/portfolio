...
export default function FizzuProject() {
  return (
    <div className="project-simple">
      ...
      {/* Short description */}
      <p>
        FIZZU is a concept soda brand featuring bold, 
        unexpected flavours brought to life through playful, 
        graphic packaging...
      </p>

      {/* Can grid */}
      <div className="can-grid">
        <CanImage src="kewpie.jpg" name="Kewpie Pop" />
        <CanImage src="yuzu.jpg" name="Ponzu Zing" />
        <CanImage src="ginger.jpg" name="Ginger Zinger" />
      </div>
...
```javascript
// Image hover
scale: isHovered ? 1.03 : 1.00  // Only 3%!
