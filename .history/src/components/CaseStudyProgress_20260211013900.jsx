...
const SECTION_TYPE_MAP = [
    ...
    { match: /lo.?fi|wireframe/i, type: "lofi" },
    { match: /iteration|hi.?fi|development/i, type: "hifi" },
    { match: /solution/i, type: "solution" },
    { match: /validation|testing/i, type: "validation" },
    { match: /learning/i, type: "learning" },
    { match: /outcome|impact/i, type: "outcome" },
    { match: /final|prototype|experience/i, type: "final" },
    { match: /next.?step/i, type: "next" },
    { match: /overview/i, type: "overview" },
];
        ...
        <>
            ...
            <nav className="toc" aria-label="Table of contents">
                ...
                <div className="toc-rail">
                    <div className="toc-rail-fill" ref={railRef} />
                </div>
