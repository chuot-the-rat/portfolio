...
/* ─────────────────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────────────────── */
/* Only key checkpoints get a glyph — everything else shows text only */
const SECTION_TYPE_MAP = [
    { match: /overview|objective|goal/i, type: "start" },
...
function detectSectionType(className, label) {
    ...
    return null; // no glyph for non-checkpoint sections
}
