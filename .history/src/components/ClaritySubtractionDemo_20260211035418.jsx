...
const Pill = ({ label, style }) => (
    <motion.div className="cs-pill" style={style}>
        {label}
    </motion.div>
);
...
const ClaritySubtractionDemo = ({
    ...
    const pills = [
        "Browse", "Discover", "Trending", "New", "Genres", "Filters",
    ];
    ...
    return (
        <section ref={sectionRef} className="cs-section">
            ...
            {/* ── Animated Canvas ── */}
            <div className={`cs-canvas ${isCompressed ? "cs-canvas--compressed" : ""}`}>
                {/* Nav bar */}
            ...
            <div className="cs-annotation">
                <AnimatePresence mode="wait">
                    ...
                    >
                        <span className="cs-phase-label">{currentPhase.label}</span>
