...
const DEFAULT_PHASES = [
    ...
    { key: "subtraction", label: "Subtraction", text: "We removed what competed." },
    { key: "compression", label: "Compression", text: "Fewer choices. Faster decisions." },
...
const ClaritySubtractionScene = ({ data }) => {
    ...
    const phases = useMemo(() => {
        ...
        return ["p0", "p1", "p2", "p3"].map((key, i) => {
            ...
            return src
                ? { key: DEFAULT_PHASES[i].key, label: src.label, text: src.text }
                : DEFAULT_PHASES[i];
        });
    }, [annotation_phases]);
