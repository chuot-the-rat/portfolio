      ...
      <div className="container">
        <div className="header-content">
          ...
          <nav className="header-nav">
            ...
            <a href="mailto:leanale003@gmail.com" className="header-nav-link">Contact</a>
            ...
            >
              {theme === 'light' ? (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M10 3V1M10 19v-2M17 10h2M1 10h2M15.657 4.343l1.414-1.414M3.93 16.07l1.414-1.414M15.657 15.657l1.414 1.414M3.93 3.93l1.414 1.414" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
