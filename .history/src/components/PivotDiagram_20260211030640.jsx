...
const FramePlaceholder = ({ label, className = "" }) => (
    <div className={`pvt-frame ${className}`}>
        ...
        >
            ...
            <rect x="24" y="24" width="120" height="10" rx="3" opacity="0.12" fill="#888" />
            <rect x="24" y="44" width="180" height="6" rx="2" opacity="0.07" fill="#888" />
            <rect x="24" y="58" width="160" height="6" rx="2" opacity="0.07" fill="#888" />
            <rect x="24" y="80" width="272" height="80" rx="4" opacity="0.06" fill="#888" />
            <rect x="24" y="172" width="60" height="8" rx="2" opacity="0.08" fill="#888" />
            <rect x="94" y="172" width="60" height="8" rx="2" opacity="0.05" fill="#888" />
        </svg>
...
const PivotCard = ({ from, to, reason, index }) => {
    ...
    return (
        <motion.article
            ...
            transition={{ duration: 0.45, delay: d, ease: [0.25, 0.1, 0.25, 1] }}
        >
            {/* ── BEFORE column ── */}
            <div className={`pvt-side pvt-side--before${inView ? " is-retired" : ""}`}>
                <FramePlaceholder label="Before" className="pvt-frame--before" />
                <p className="pvt-prev-text">
                    <span className="pvt-prev-inner">
                        Previously: {from}
                    </span>
                </p>
            </div>
            ...
            <div className="pvt-side pvt-side--after">
                ...
                >
                    <FramePlaceholder label="After" className="pvt-frame--after" />
                ...
                <motion.h4
                    ...
                    animate={inView ? { opacity: 1, y: 0 } : {}}
                    transition={{ duration: 0.35, delay: d + 0.4, ease: "easeOut" }}
                >
                    {to}
                </motion.h4>
