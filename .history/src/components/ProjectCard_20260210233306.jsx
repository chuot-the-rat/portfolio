 ...
 *
 * Chaos Mode: Original smooth hover
 * - Soft lift and scale
...
const ProjectCard = ({
    ...
    const handleMouseEnter = () => {
        if (isWorkMode) {
            ...
            // Chaos Mode: No system labels, smooth hover
            setSystemLabel("");
        }
        onHover();
    };
    ...
    const isStandalone = isStandaloneProject(project.id);
        ...
        >
            ...
            >
                ...
                <div className="project-card-content">
                    ...
                    >
                        {isStandalone ? "[view_project]" : "[view_case_study]"}
                    </motion.div>
                </div>
            </motion.article>
        </Link>
