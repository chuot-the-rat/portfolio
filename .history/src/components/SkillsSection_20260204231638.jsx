...
// Work Mode: Skills organized with editorial hierarchy and symbols
    ...
    groups: [
        {
            ...
            emphasis: "large",
            skills: [
                { name: "UI/UX", symbol: "[]", level: "expert" },
                { name: "Prototyping", symbol: "[]", level: "expert" },
                { name: "User Research", symbol: "[]", level: "advanced" },
                { name: "Wireframing", symbol: "[]", level: "expert" },
                { name: "Design Systems", symbol: "[]", level: "intermediate" },
            ],
        },
        {
            id: "front-end",
            ...
            emphasis: "medium",
            skills: [
                { name: "HTML/CSS", symbol: "<>", level: "expert" },
                { name: "React", symbol: "<>", level: "intermediate" },
                { name: "JavaScript", symbol: "{}", level: "intermediate" },
                { name: "Git/GitHub", symbol: "{}", level: "intermediate" },
            ],
        },
        {
            id: "motion",
            ...
            emphasis: "large",
            skills: [
                { name: "Motion", symbol: "[]", level: "advanced" },
                { name: "After Effects", symbol: "<>", level: "learning" },
                { name: "Framer", symbol: "<>", level: "advanced" },
            ],
        },
        {
            id: "visual",
            label: "_ARCHITECTURE_",
            symbol: "_",
            emphasis: "small",
            skills: [
                { name: "Typography", symbol: "_", level: "expert" },
                { name: "Color Theory", symbol: "_", level: "expert" },
                { name: "Accessibility", symbol: "*", level: "intermediate" },
            ],
        },
        {
            id: "tools",
            ...
            emphasis: "medium",
            skills: [
                { name: "Figma", symbol: "<>", level: "expert" },
                { name: "Illustrator", symbol: "<>", level: "advanced" },
                { name: "VS Code", symbol: "<>", level: "expert" },
                { name: "Notion", symbol: "<>", level: "expert" },
            ],
        },
    ],
};
        ...
        return (
            ...
            >
                ...
                <div className="skills-editorial-grid">
                    {skillsDataWorkMode.groups.map((group, groupIndex) => {
                        const symbolMap = {
                            "[]": "[",
                            "<>": "<",
                            "{}": "{",
                        ...
                        return (
                            <motion.div
                                key={group.id}
                                className={`skill-group skill-group-${group.emphasis}`}
                            ...
                            >
                                {/* Group Label with Editorial Scale */}
                                <motion.h3
                                    className={`skill-group-label emphasis-${group.emphasis}`}
                                    initial={{ opacity: 0, x: -10 }}
                                    animate={{ opacity: 1, x: 0 }}
                                    transition={{
                                        duration: 0.3,
                                        delay: groupIndex * 0.08 + 0.1,
                                    }}
                                >
                                    {group.label}
                                </motion.h3>
                                    ...
                                    {group.skills.map((skill, skillIndex) => (
                                        <motion.div
                                            ...
                                            style={{
                                                ...
                                                "--float-delay": `${(groupIndex * 4 + skillIndex) * 0.15}s`,
                                            }}
                                            initial={{
                                                opacity: 0,
                                                scale: 0.95,
