...
const skillsData = {
    design: {
        label: "Design",
        skills: [
            { name: "User Research", level: "2+ years" },
            { name: "Wireframing", level: "3+ years" },
            { name: "Prototyping", level: "3+ years" },
            { name: "User Testing", level: "1+ year" },
            { name: "User Flows", level: "2+ years" },
            { name: "Journey Mapping", level: "1+ year" },
        ],
    },
    ui: {
        label: "UI Design",
        skills: [
            { name: "Figma", level: "3+ years" },
            { name: "Typography", level: "3+ years" },
            { name: "Color Theory", level: "3+ years" },
            { name: "Accessibility", level: "1+ year" },
            { name: "Responsive Design", level: "2+ years" },
            { name: "Design Systems", level: "1+ year" },
        ],
    },
    development: {
        label: "Development",
        skills: [
            ...
            { name: "Git/GitHub", level: "1+ year" },
        ],
    },
    tools: {
        label: "Tools",
        skills: [
            { name: "Adobe Illustrator", level: "2+ years" },
            { name: "Photoshop", level: "1+ year" },
            { name: "After Effects", level: "Learning" },
            { name: "Framer", level: "1+ year" },
            { name: "VS Code", level: "3+ years" },
            { name: "Notion", level: "3+ years" },
        ],
    },
};
