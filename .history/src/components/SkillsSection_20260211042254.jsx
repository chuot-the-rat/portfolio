...
export default function SkillsSection({ variant = "grid" }) {
    ...
    const startPanelAnim = useCallback((script) => {
        ...
        const frames = asciiAnimations[script.animType] || asciiAnimations.arrows;
    ...
    const panelFrames = asciiAnimations[panelScript.animType] || asciiAnimations.arrows;
                ...
                <div className="skills-ascii-panel">
                    <div className="skills-ascii-panel-inner">
                        {panelScript.lines.map((line, i) => (
                            <div key={i} className="skills-ascii-line">
                                {line}
                            </div>
                        ))}
