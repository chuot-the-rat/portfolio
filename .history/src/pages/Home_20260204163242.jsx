      ...
      .then(async (projectsList) => {
        ...
        const projectsWithData = await Promise.all(
          projectsList.map(async (project) => {
            try {
              const response = await fetch(`/${project.folder}/data.json`)
        ...
        <div className="container">
          ...
          >
            ...
            <p className="home-hero-subtitle">
              UI/UX Designer & Developer creating thoughtful user experiences through research-driven design and clean code.
            </p>
          </motion.section>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-links">
              ...
              <a href="https://linkedin.com/in/leanale" target="_blank" rel="noopener noreferrer" className="footer-link">
                LinkedIn
              </a>
              <a href="https://github.com/chuot-the-rat" target="_blank" rel="noopener noreferrer" className="footer-link">
                GitHub
              </a>
            </div>
