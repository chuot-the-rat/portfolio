...
const Home = () => {
    ...
    const projectMetadata = {
        ...
        prolog: { status: "research", role: "design/development", symbol: "[ProLog_v2]" },
        sidequest: { status: "in-progress", role: "ux/ui", symbol: "{SideQuest}" },
        "fizzu-soda": { status: "prototype", role: "ui/ux", symbol: "<FIZZU />" },
    };
            ...
            <main className="home-main">
                <div className="container">
                    ...
                    <section className="home-projects" id="projects">
                        ...
                        >
                            <span className="terminal-prompt">&gt;</span>
                            <span className="terminal-text"> projects_index</span>
                            <span className="terminal-count"> [{projects.length} entries]</span>
                        </motion.div>
                                    ...
                                    {projects.map((project, index) => (
                                        ...
                                        >
                                            <ProjectCard
                                                ...
                                                hoverPattern={project.hoverPattern}
                                            />
                                        </motion.div>
                                    ))}
                                </div>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <motion.span
                                                    ...
                                                    animate={{
                                                        opacity: hoveredProject?.id === project.id ? 0.65 : 0.5
                                                    }}
                                                ...
                                                <motion.span
                                                    ...
                                                    animate={{
                                                        x: hoveredProject?.id === project.id ? 4 : 0,
                                                        opacity: hoveredProject?.id === project.id ? 1 : 0.85
                                                    }}
                                                    transition={{ duration: 0.16, ease: [0.2, 0.8, 0.2, 1] }}
                                                >
                                                    {project.systemMetadata?.symbol || project.title}
                                                </motion.span>
                                                ...
                                                <motion.span
                                                    ...
                                                    initial={{ opacity: 0 }}
                                                    animate={{
                                                        opacity: hoveredProject?.id === project.id ? 0.6 : 0
                                                    }}
                                                    transition={{ duration: 0.16 }}
                                                >
                                                    [status: {project.systemMetadata?.status || 'active'}]
                                                </motion.span>
                                                ...
                                                <motion.span
                                                    ...
                                                    transition={{ duration: 0.16 }}
                                                >
                                                    {project.hoverPattern === 'pattern-a' && '[preview_loaded]'}
                                                    {project.hoverPattern === 'pattern-b' && '[media_active]'}
                                                    {project.hoverPattern === 'pattern-c' && '[hover_ready]'}
                                                    {project.hoverPattern === 'pattern-d' && '[video_ready]'}
                                                </motion.span>
                                    ...
                                    <AnimatePresence mode="wait">
                                        {hoveredProject && (
                                            <PreviewPanel
                                                ...
                                                hoverPattern={hoveredProject.hoverPattern}
                                            />
                                        )}
                                    </AnimatePresence>
                                </div>
