                ...
                <div className="container">
                    ...
                    {project.research && (
                        ...
                        >
                            ...
                            {/* Research Methods */}
                            {project.research.methods && project.research.methods.length > 0 && (
                                <div className="research-methods">
                                    <h3 className="subsection-title">Methods</h3>
                                    <ul className="methods-list">
                                        {project.research.methods.map((method, index) => (
                                            <li key={index} className="method-item">{method}</li>
                                        ))}
                                    </ul>
                                </div>
                            )}
                            ...
                            {/* Key Findings */}
                            {project.research.keyFindings && project.research.keyFindings.length > 0 && (
                            ...
                            {project.research.images && project.research.images.length > 0 && (
                                <ImageGallery images={project.research.images} />
                            )}
                        </motion.section>
                    )}
                    ...
                    {project.development && (
                        ...
                        >
                            ...
                            {/* Technical Decisions */}
                            {project.development.technicalDecisions && project.development.technicalDecisions.length > 0 && (
                                <div className="technical-decisions">
                                    <h3 className="subsection-title">Technical Decisions</h3>
                                    <ul className="decisions-list">
                                        {project.development.technicalDecisions.map((decision, index) => (
                                            <motion.li
                                                key={index}
                            ...
                            {/* Constraints */}
                            {project.development.constraints && project.development.constraints.length > 0 && (
                                <div className="development-constraints">
                                    <h3 className="subsection-title">Constraints</h3>
                                    <ul className="constraints-list">
                                        {project.development.constraints.map((constraint, index) => (
                    ...
                    {project.iterations && (
                        ...
                        >
                            ...
                            {project.iterations.images && project.iterations.images.length > 0 && (
                                <ImageGallery images={project.iterations.images} />
                            )}
                    ...
                    {project.solution && (
                        ...
                        >
                            ...
                            {project.solution.images && project.solution.images.length > 0 && (
                                <ImageGallery images={project.solution.images} />
                            )}
                    ...
                    {project.validation && (
                        ...
                        >
                            ...
                            {/* Validation Outcomes */}
                            {project.validation.outcomes && project.validation.outcomes.length > 0 && (
                                <div className="validation-outcomes">
                                    <h3 className="subsection-title">Outcomes</h3>
                                    <ul className="outcomes-list">
                                        {project.validation.outcomes.map((outcome, index) => (
                                    ...
                                    {project.nextSteps.items.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="step-content">
                                                <span className="step-text">{item.text || item}</span>
                                                {item.priority && (
                                                    <span className="step-priority">{item.priority} priority</span>
                                                )}
                                            </div>
                                        </motion.li>
                                    ))}
                    ...
                    {project.finalExperience && (
                        <motion.section
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <span className="section-label">Final Experience</span>
