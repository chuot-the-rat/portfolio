...
const ProjectDetail = () => {
    ...
    return (
        <div className="project-detail">
            ...
            {/* Vertical progress indicator — right sidebar */}
            {project.pivot?.timelineSteps?.length > 0 && (
                <CaseStudyProgress
                    steps={project.pivot.timelineSteps}
                    highlightedStep={project.pivot.highlightedStep}
