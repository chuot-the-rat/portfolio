...
import ClaritySubtractionDemo from "../components/ClaritySubtractionDemo";
import CaseStudyTOCProgress from "../components/CaseStudyProgress";
                    ...
                    <div className="project-content-layout">
                        <div className="project-content-main">
                            ...
                            {project.research && (
                                ...
                                >
                                    ...
                                    {project.research.keyFindings &&
                                        project.research.keyFindings.length >
                                            0 && (
                            ...
                            {project.challenges && (
                                ...
                                >
                                    ...
                                    {project.challenges.pivots &&
                                        project.challenges.pivots.length >
                                            0 && (
                                            <PivotDiagram
                                                pivots={
                                                    project.challenges.pivots
                            ...
                            {project.pivot?.weightLifted && (
                                project.pivot.weightLifted.displayMode === "slider" ? (
                                    <ClaritySubtractionDemo
                                        principleLabel={project.pivot.weightLifted.principleLabel}
                                        title={project.pivot.weightLifted.title}
                                        caption={project.pivot.weightLifted.caption}
                                    />
                                ) : (
                                    <WeightLiftedPivot
                                        {...project.pivot.weightLifted}
                            ...
                            {project.development && (
                                ...
                                >
                                    ...
                                    {project.development.constraints &&
                                        project.development.constraints.length >
                                            0 && (
                            ...
                            {project.iterations && (
                                ...
                                >
                                    ...
                                    {project.iterations.images &&
                                        project.iterations.images.length >
                                            0 && (
                                            <ImageGallery
                                                images={
                                                    project.iterations.images
                            ...
                            {project.solution && (
                                ...
                                >
                                    ...
                                    {project.solution.features &&
                                        project.solution.features.length >
                                            0 && (
                            ...
                            {project.validation && (
                                ...
                                >
                                    ...
                                    {project.validation.quotes &&
                                        project.validation.quotes.length >
                                            0 && (
                                    ...
                                    {project.validation.outcomes &&
                                        project.validation.outcomes.length >
                                            0 && (
                            ...
                            {project.learnings && (
                                ...
                                >
                                    ...
                                    {project.learnings.insights &&
                                        project.learnings.insights.length >
                                            0 && (
                        ...
                        {/* Notion-style TOC + Progress sidebar */}
                        <CaseStudyTOCProgress contentRef={contentRef} />
                    </div>
                </div>
            </div>
        </div>
