                ...
                <div className="container">
                    <div className="project-content-layout">
                        <div className="project-content-main">
                            ...
                            {/* Clarity Subtraction Scene — scroll-hijack (data-driven) */}
                            {project.pivot?.clarityScene && (
                                <ClaritySubtractionScene
                                    data={project.pivot.clarityScene}
                                />
                            )}

                            {/* Weight Lifted — Before/After simplification visual (fallback for projects without clarity_scene) */}
