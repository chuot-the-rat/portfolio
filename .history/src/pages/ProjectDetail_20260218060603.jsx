                ...
                (() => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {project.personas.users?.length > 0 && (
                                <div className="personas-grid">
                                    {project.personas.users.map(
                                        (persona, i) => (
                                            <motion.div
                                                key={i}
                                            ...
                                            >
                                                ...
                                                {persona.goals?.length > 0 && (
                                                    <div className="persona-list-group">
                                                        <h4 className="persona-list-label">
                                                            Goals
                                                        </h4>
                                                ...
                                                {persona.frustrations?.length >
                                                    ...
                                                    <div className="persona-list-group">
                                                        ...
                                                        <ul className="persona-list persona-list--frustrations">
                            ...
                            <FigmaEmbed
                                linkOnly
                                caption="View full personas"
                                prototypeLink={project.personas.prototypeLink}
                            />
                        </motion.section>
                    );
                })()}
                    ...
                    return (
                        ...
                        >
                            ...
                            {project.hifi.screens?.length > 0 && (
                                <div className="hifi-screens">
                                    {project.hifi.screens.map((screen, i) => (
                                        <motion.div
                                            key={i}
                                            className="hifi-screen-card"
                                            initial={{ opacity: 0, y: 20 }}
                                            whileInView={{
                                                opacity: 1,
                                                y: 0,
                                        ...
                                        >
                                            ...
                                            <h3 className="hifi-screen-name">
                                                {screen.name}
                                            </h3>
                                            <p className="hifi-screen-desc">
                                                {screen.description}
                                            </p>
                                        </motion.div>
                                    ))}
                    ...
                    return (
                        ...
                        >
                            ...
                            {project.finalPresentation.embed && (
                                <FigmaEmbed
                                    src={
                                        project.finalPresentation.embed.src
                                    }
                                    title={
