    ...
    return (
        <div className="project-layout">
                ...
                <div className="container">
                        ...
                        >
                            ...
                            <ul className="pl-objectives">
                                {project.objectives.map((obj, i) => (
                                    ...
                                    >
                                        <span className="objective-icon">{i + 1}</span>
                    ...
                    {project.designProcess && project.designProcess.length > 0 && (
                        <motion.section
                            ...
                            transition={{ duration: 0.6 }}
                        >
                            <span className="section-label">03 — Can to Concept</span>
                                ...
                                {project.designProcess.map((phase, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="pl-process-info">
                                            <h3 className="pl-process-title">{phase.title}</h3>
                                            {phase.duration && (
                                            ...
                                            {phase.activities && (
                                                <div className="pl-process-activities">
                                                    {phase.activities.map((act, j) => (
                                                        <span key={j} className="pl-activity-tag">
                                                            {act}
                                                        </span>
                                                    ))}
                                                </div>
                    ...
                    <div className="pl-gallery-grid">
                        {allImages.map((img, i) => (
                            <motion.div
                                ...
                                onClick={() => setLightboxImage(resolveImage(img.src))}
                            >
                                <img
                                ...
                                />
                                {img.caption && (
                                    <span className="pl-gallery-caption">{img.caption}</span>
                                )}
                            </motion.div>
                        ))}
                    </div>
            ...
            <div className="pl-footer-nav">
                <div className="container">
                    <Link to="/" className="pl-footer-link">
            ...
            <div className="pl-section-images">
                {images.map((img, i) => (
                    <motion.div
                        ...
                        onClick={() => onImageClick?.(resolveImage?.(img.src) || img.src)}
                    >
                        <img
