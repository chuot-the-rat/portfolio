...
export const mapCaseStudyToProject = (caseStudy) => {
    ...
    return {
        ...
        development: sections?.development ? {
            ...
            technicalDecisions: sections.development.technical_decisions || [],
        ...
        validation: sections?.validation ? {
            ...
            quotes: sections.validation.key_quotes || sections.validation.quotes || sections.validation.participant_quotes || [],
        ...
        learnings: sections?.what_i_learned ? {
            ...
            insights: Array.isArray(sections.what_i_learned) 
                ? sections.what_i_learned.map(item => ({
                    ...
                    description: item.reflection || item.explanation || item.description
                }))
                : sections.what_i_learned.insights?.map(insight => ({
                    title: insight.point || insight.insight || insight.title,
                    description: insight.explanation || insight.reflection || insight.description
                })) || []
        } : null,
        ...
        nextSteps: sections?.next_steps ? {
            ...
            items: Array.isArray(sections.next_steps) 
                ...
                : (sections.next_steps.planned || sections.next_steps.items || []).map(item => ({
                    text: typeof item === 'string' ? item : item.item,
                    priority: typeof item === 'object' ? item.priority : null
                }))
        } : null,
