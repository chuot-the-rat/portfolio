...
| -------------- | ----------------------- | -------------------------------------------------- |
| `fadeIn`       | _500ms_ (scroll-reveal) | `opacity: 0 → 1`                                   |
| `fadeInUp`     | _500ms_                 | `opacity: 0 → 1, transform: translateY(20px) → 0`  |
| `fadeInDown`   | _500ms_                 | `opacity: 0 → 1, transform: translateY(-20px) → 0` |
| `slideInLeft`  | _500ms_                 | `opacity: 0 → 1, transform: translateX(-30px) → 0` |
| `slideInRight` | _500ms_                 | `opacity: 0 → 1, transform: translateX(30px) → 0`  |
| `scaleIn`      | _500ms_                 | `opacity: 0 → 1, transform: scale(0.95) → 1`       |
...
| `accent-flicker`      | _duration undefined_ | Color opacity flicker                                        |
| `symbol-oscillate`    | _duration undefined_ | Micro rotation oscillation                                   |
| `char-glitch`         | _duration undefined_ | Character displacement glitch                                |
| `micro-flicker`       | _duration undefined_ | Subtle opacity flicker                                       |
...
/* Links & buttons */
transition:
    transform var(--dur-ui) var(--ease-out-premium),
...
transition:
    opacity var(--dur-slow) var(--ease-out-premium),
...
| Pattern                        | Duration  | Easing                         | File(s)           | Details                                                                   |
| ------------------------------ | --------- | ------------------------------ | ----------------- | ------------------------------------------------------------------------- |
| **CTA button press (active)**  | _instant_ | Spring `[0.4, 0, 0.2, 1]`      | Home.jsx          | Scale 0.99, `transform: translateY(-1px)`                                 |
...
| Pattern                      | Duration              | Easing                           | File(s)                | Details                                                        |
| ---------------------------- | --------------------- | -------------------------------- | ---------------------- | -------------------------------------------------------------- |
| **Marquee scroll**           | _40s (default)_       | `linear`                         | Marquee.css            | Infinite horizontal scroll, pauses on hover                    |
