...
export const SIM_RULES = [
    // ─── User Type: Student Writer ────────────────────────────────────────────
    {
        ...
        output: {
            ...
            risks: ["Power users may feel constrained by simplified toolset"],
            tests: ["Can a first-time user start writing within 60 seconds?"],
        },
    },
    ...
    // ─── User Type: Academic Researcher ───────────────────────────────────────
    {
        ...
        output: {
            ...
            risks: ["Non-technical users may face a steep learning curve"],
            tests: [
    ...
    // ─── User Type: Editor ────────────────────────────────────────────────────
    {
        ...
        output: {
            ...
            removed: ["Solo writing prompts", "Personal brainstorm canvas"],
            tradeoffs: [
                "Tool optimized for reviewing, not originating content",
            ],
            risks: ["Writers may feel surveilled rather than supported"],
            tests: [
    ...
    // ─── Device: Tablet ───────────────────────────────────────────────────────
    {
        ...
        output: {
            ...
            removed: ["Keyboard shortcut system", "Multi-pane split layout"],
            tradeoffs: ["Reduced screen real estate limits simultaneous views"],
            risks: [
    ...
    // ─── Device: Desktop ──────────────────────────────────────────────────────
    {
        ...
        output: {
            ...
            removed: ["Simplified single-column layout"],
            tradeoffs: [
    ...
    // ─── Constraint: Collaboration Priority ───────────────────────────────────
    {
        ...
        output: {
            ...
            risks: ["Steeper onboarding curve for first-time collaborators"],
            tests: [
